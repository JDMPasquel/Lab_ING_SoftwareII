    ...
    public long calculateCost(Vehicle veh, LocalDateTime input, LocalDateTime output) {
        ...
        if(minutesDifference > 0){
            if(hourDifference == 0){
                ...
                if(hourDifference > 1){
                    priece = 2000 + ((hourDifference - 1)*1000) + (int)(minutesDifference * 1000)/60;
                }
                else{
                    priece = 2000 + (minutesDifference * 1000)/60;
                }
            }
        }
        else{
            if(minutesDifference == 0){
                if(hourDifference == 1){
                    ...
                    priece = 2000 + (hourDifference * 1000);
                }
            }
            else{
                /**
                ...
                if(minutesOutput > 0){
                    if(hourOutput == 0){
                        ...
                        if(hourOutput > 1){
                            priece = 2000 + ((hourOutput - 1)*1000) + (minutesOutput * 1000)/60;
                        }
                        else{
                            priece = 2000 + (minutesOutput * 1000)/60;
                        }
                    }
                }
                else{
